     ...
     jsimplex.prototype.normalizar=function()
     {
         ...
         try
         {
            ...
            for (i=0; i<=this.ntotal; i++)
            {
                ...
                this.c[4][i]=""; //Nombre de la variable...
            }
            ...
            s= s+ "</table>";
             ...
             for (i=1; i<= this.ntotal; i++)
             {
                 ...
                 if (i>=(this.noxs+this.noss +  1) )
                 {
                     ...
                     this.c[4][i]= "a"+(i-this.noxs-this.noss);
                     if (this.maximizar)
                     {
                        this.c[2][i]=-1;
                    }else
 ...
 try
 {
   ...
   {  
    ...
    {                
        ...
        if (j==0)
        {
         ...
         for (j=1; j<=this.ntotal; j++)
         {
          ...
          num = redondear(num,2),
          s= s + this.c[0][j] + " = " + num +"" ;
          s = s + '<input type="hidden" name="txts' + this.c[4][j] + '" id="txts' + this.c[4][j] + '" value="'+num+'" maxlength="6"><br>';      
          console.table(this.c);    
      }
      s =  s +"<b><font color='#0000FF'>Z</font></b> = "+m( this.zeta[2][this.ntotal+1], this.zeta[1][this.ntotal+1]   );
      s = s + '<input type="hidden" name="txtz" id="txtz" value="'+m( this.zeta[2][this.ntotal+1], this.zeta[1][this.ntotal+1])+'" maxlength="6"><br>';   
    ...
    if (this.tiposolucion==4)
    {
        ...
        s = s + '<input type="hidden" id="contx" name="contx" value="'+this.contx+'"/>';
        s = s + '<input type="hidden" id="conts" name="conts" value="'+this.conts+'"/>';
        s = s + '<input type="hidden" id="conta" name="conta" value="'+this.conta+'"/>';
    document.getElementById(div).innerHTML+= s;

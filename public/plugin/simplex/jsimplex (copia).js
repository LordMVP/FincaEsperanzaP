          ...
          jsimplex.prototype.normalizar = function() {
            ...
            try {
              ...
              for (i = 1; i <= this.norestricciones; i++) {
                switch (this.problema[i][this.noxs + 1]) {
                  ...
                  for (i = 1; i <= this.ntotal; i++) {
                      //llenar los nombres...
                      if (i <= this.noxs) {
                        this.c[0][i] = "<tr><th><td><b><font size='3' color='#0000FF'>X</font></b><sub>" + i + " = </sub > </td</th>";
                          this.c[3][i] = 1; //Variables de decision 1
                        }
                        s = s + "<tr><th><b><font color='#0000FF'>Z</font></b></th><th><b><font color='#0000FF'>" + m(this.zeta[2][this.novariables + 1], this.zeta[1][this.ntotal + 1]) + "</font></b></th></tr>"
              ...
              jsimplex.prototype.gauss = function(ifila, icolumna) {
                ...
                var num = 0;
                try {
                  if (ifila > this.norestricciones) {
                    return false;
                  }
                  if (icolumna > this.ntotal + 1) {
                    return false;
                  }
              ...
              for (j = 1; j <= this.novariables; j++) {
                num = this.valorvariable(j);
                num = redondear(num, 2);
                  //s = s + this.c[0][j] + " = " + num + "";
                  s = s + this.c[0][j] + "<th><td><font size='5' color = '#0000FF' ></font>" + num + "</td</th></tr>"
                }
                s = s + "<tr><th></th><th><b size='5'><font  color='#0000FF'>Z = </font></b></th><th></th><th><b><font size='4'color='#0000FF'>" + m(this.zeta[2][this.novariables + 1], this.zeta[1][this.ntotal + 1]) + "</font></b></th></tr>"
              ...
              jsimplex.prototype.imprimir = function() {
                $("section#imprimir").printArea();
              }

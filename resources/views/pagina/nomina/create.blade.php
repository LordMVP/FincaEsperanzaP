  ...
  <div class="col-md-12">
    ...
    <div class="box box-info">
      ...
      <div class="box-body">
       ...
       <div class="col-xs-3">
        ...
        <div class="input-group">
          {!! Form::select('id', $aux_usuarios, null, ['class' => 'form-control', 'required', 'placeholder' => 'Seleccione usuario', 'id' => 'id', 'name' => 'cedula', 'required']) !!}
        </div>
      </div>
      ...
      <div class="col-xs-3">
        ...
        <div class="input-group">
          <input type="text" id="sueldobasico" name="sueldobasico" class="form-control" readonly="">
        </div>
      </div>
    ...
    <div class="box box-info">
      ...
      <div class="box-body">
        ...
        <div class="input-group">
          ...
          <!-- /btn-group -->
          <input type="text" class="form-control" id="diastrabajados" name="diastrabajados" value="0">
        ...
        <div class="input-group col-md-12">
          ...
          <!-- /btn-group -->
          <input type="text" class="form-control" id="sueldo" name="sueldo" readonly="" value="0">
        </div>
        ...
        <div class="input-group">
          ...
          <!-- /btn-group -->
          <input type="text" class="form-control" id="hextras" name="horash" readonly="" value="0">
          <div class="input-group-btn">
        ...
        <div class="input-group">
          <div class="input-group-btn">
            <input type="text" class="form-control" id="auxtransporte" name="transporte" readonly="" value="0">
          </div>
          <!-- /btn-group -->
        </div>
        ...
        <div class="input-group">
          ...
          <!-- /btn-group -->
          <input type="text" class="form-control" id="comisiones" name="comisiones" readonly="" value="0">
          <div class="input-group-btn">
        ...
        <div class="input-group col-md-12">
          ...
          <!-- /btn-group -->
          <input type="number" class="form-control" id="bonificaciones" name="bonificaciones" value="0">
        </div>
      ...
      <div class="box-body">
       ...
       <div class="col-md-12">
        ...
        <div class="input-group">
          ...
          <!-- /btn-group -->
          <input type="text" class="form-control" id="salud" name="salud" readonly="" value="0">
          <div class="input-group-btn">
        ...
        <div class="input-group col-md-12">
          ...
          <!-- /btn-group -->
          <input type="text" class="form-control" id="pension" name="pension" readonly="" value="0">
        </div>
        ...
        <div class="input-group col-md-12">
          ...
          <!-- /btn-group -->
          <input type="text" class="form-control" id="riesgos" name="riesgos" readonly="" value="0">
        </div>
        ...
        <div class="input-group">
          ...
          <!-- /btn-group -->
          <input type="text" class="form-control" id="retencion" name="rtefuente" readonly="" value="0">
          <div class="input-group-btn">
        ...
        <div class="input-group">
          <div class="input-group-btn">
            <input type="text" class="form-control" id="libranza" name="libranza" value="0">
          </div>
          <!-- /btn-group -->
        </div>
        ...
        <div class="input-group col-md-12">
          ...
          <!-- /btn-group -->
          <input type="text" class="form-control" id="fondo" name="fondos" value="0">
        </div>
        ...
        <div class="input-group col-md-12">
          ...
          <!-- /btn-group -->
          <input type="text" class="form-control" id="embargos" name="embargos" value="0">
        </div>
    ...
    <div class="box-body">
     ...
     <div class="col-md-12">
      ...
      <div class="input-group">
        ...
        <!-- /btn-group -->
        <input type="text" class="form-control" id="caja" name="caja" readonly="" value="0">
        <div class="input-group-btn">
      ...
      <div class="input-group col-md-12">
        ...
        <!-- /btn-group -->
        <input type="text" class="form-control" id="icbf" name="icbf" readonly="" value="0">
      </div>
      ...
      <div class="input-group col-md-12">
        ...
        <!-- /btn-group -->
        <input type="text" class="form-control" id="sena" name="sena" readonly="" value="0">
      </div>
      ...
      <div class="input-group">
        ...
        <!-- /btn-group -->
        <input type="text" class="form-control" id="cesantias" name="cesantias" readonly="" value="0">
        <div class="input-group-btn">
      ...
      <div class="input-group col-md-12">
        ...
        <!-- /btn-group -->
        <input type="text" class="form-control" id="intecesantias" name="intecesantias" readonly="" value="0">
        <div class="input-group-btn">
      ...
      <div class="input-group col-md-12">
        ...
        <!-- /btn-group -->
        <input type="text" class="form-control" id="primaservi" name="primaservi" readonly="" value="0">
        <div class="input-group-btn">
      ...
      <div class="input-group col-md-12">
        ...
        <!-- /btn-group -->
        <input type="text" class="form-control" id="vacaciones" name="vacaciones" readonly="" value="0">
        <div class="input-group-btn">
    ...
    <div class="box-body">
      ...
      <div class="col-lg-4">
        <div class="input-group">
          ...
          <!-- /btn-group -->
          <input readonly="" type="text" class="form-control" id="tdevengado" name="devengado" value="0">
          <div class="input-group-btn">
          ...
          <!-- /btn-group -->
          <input readonly="" type="text" class="form-control" id="tdeducido" name="deducido" value="0">
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          ...
          <div class="input-group">
            ...
            <input readonly="" type="text" class="form-control" id="totaltotal" name="total" value="  ">
            <div class="input-group-btn">
      ...
      <div class="row">
        <div class="col-lg-4">
          <button type="submit" class="btn btn-primary" data-dismiss="modal" onclick="return confirm('¿Seguro Desea Almacenar esta nomina?')">Guardar</button>

...
<div class="row">
   <div class="col-md-12">
      <script type="text/javascript">
        ...
        {
         s= s+ "<td><input type='number' name='txtx" +  j + "' size='5' onkeypress='' onblur='jmodelo()' maxlength='6' id='txtx" + j + "'  style='width:70px;' step='any'></td> ";     
      }  
      s= s+"<td></td>";
      s= s+"<td></td>";        
      s= s+"</tr>"; 
      ...
      for (i=1; i<=norestricciones; i++)
      {
        ...
        for (j=1; j<=novariables; j++)
        {
         s= s+"<td><input type='number' name='txtr"+i+"x"+j+"' id='txtr"+i+"x"+j+"'  size='5' onkeypress='' onblur='jmodelo()' maxlength='6'  style='width:70px;' step='any'></td>";
      }
      ...
      s= s + "<td> <input type='number' name='txtrhs"+i+"' size='5' onkeypress='' onblur='jmodelo()' maxlength='6' id='txtrhs"+i+"' style='width:70px;' step='any'></td>";          
      s= s+"</tr>";
   }       

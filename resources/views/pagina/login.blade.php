...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="{{ route('pagina.login') }}" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>LTE</b>-</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Finca</b>LTE</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="#"><i class="fa fa-circle-o text-red"></i> <span>Información</span></a></li>
        <li><a href="#"><i class="fa fa-circle-o text-yellow"></i> <span>Contactanos</span></a></li>
        <li><a href="{{ route('pagina.login') }}"><i class="fa fa-circle-o text-aqua"></i> <span>Ingreso</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>

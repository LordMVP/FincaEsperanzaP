  ...
  <div class="box box-primary">
    ...
    <div class="box-body">
      ...
      <div class="form-group">
        ...
        {!! Form::select('clase', ['ACTIVO' => 'ACTIVO', 'PASIVO' => 'PASIVO', 'PATRIMONIO' => 'PATRIMONIO', 'INGRESOS' => 'INGRESOS', 'GASTOS' => 'GASTOS', 'COSTOS' => 'COSTOS'], $puc->clase, ['class' => 'form-control', 'placeholder' => 'Seleccione Clase', 'required']) !!}

        {!! Form::label('Estado', 'Estado') !!}
        {!! Form::select('estado', ['1' => 'Activo', '0' => 'Inactivo'], $puc->estado, ['class' => 'form-control', 'placeholder' => 'Seleccione Estado', 'required']) !!}
